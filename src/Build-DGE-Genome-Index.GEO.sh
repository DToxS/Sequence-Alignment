#!/usr/bin/env bash
# Build the STAR index of human reference genome library for 3'-DGE
...
REF_INDEX_DIR_NAME="STAR-Index-${STAR_VER}-DGE"
REF_INDEX_DIR_PATH="${HG_REF_DIR}/${REF_INDEX_DIR_NAME}"

# Set the input arguments.
# 3'-DGE mRNA sequence data files have a read length of 46.
READ_LENGTH="46"
THREAD_NUMBER="16"
...
if [ ${EXIT_CODE} -eq 0 ]; then
	echo "Building the STAR index of human reference genome library for 3'-DGE mRNA-seq data ..."
